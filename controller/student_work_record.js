...
const updateStudentWork=(data)=>{
   ...
   console.log(is_upload_word)
   console.log(is_upload_video)
...
const getDetail = (data)=>{
   ...
   where student_work_record.id=${homeWorkId} and file_storage.module_name='${module_name}' and file_storage.is_deleted=${0} and student_work_record.is_deleted=${0} `;
