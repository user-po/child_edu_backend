...
router.get("/getUnqualifiedStudentsHistory",(req,res,next)=>{
  let result = getUnqualifiedStudentsHistory(req.query);
...
router.get('/getOrganizationDetailById',  (req,res,next)=>{
	//req.body = {"homeWorkId":1,"is_up_to_standard":1}
    const result = getOrganizationDetailById(req.query);
	return result.then(data=>{
