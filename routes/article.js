...
router.get('/get',async (req,res,next)=>{
    let {module_code,module_id,title,release_time,issuer,is_recommend,modified_time,play_count,curPage,userType,userId,article_type_name} = req.query;

    let result = await getArticle(module_code,module_id,title,release_time,issuer,is_recommend,modified_time,play_count,curPage,userType,userId,article_type_name);
